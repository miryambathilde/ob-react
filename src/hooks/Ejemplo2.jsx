 ...
 * useEffect() - controla los cambios en la vista y ciclo de vida del componente
 */
...
const Ejemplo2 = () => {
	 ...
	 * En caso de que el cambio sea en el contador2, no se jecutará
	 */
 ...
 */
	/**
	 * ? Caso 2: Ejecutar SÓLO cuando cambie el CONTADOR1 o CONTADOR2
	 * Cada vez que haya un cambio en el contador1, se ejecuta lo que diga el useEffect()
